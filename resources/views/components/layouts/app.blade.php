...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="{{ asset('images/favicon.svg') }}?v=rounded">
    <link rel="shortcut icon" type="image/svg+xml" href="{{ asset('images/favicon.svg') }}?v=rounded">
    <link rel="apple-touch-icon" href="{{ asset('images/logo-jsiaga.png') }}">
    <link rel="preload" as="image" href="{{ asset('images/logo-jsiaga.png') }}" type="image/png" fetchpriority="high">
    ...
    <script type="application/json" id="ui-translations">{!! json_encode([
        ...
        'chat' => [
            'online' => __('ui.chat.ready'),
            'offline' => __('ui.chat.offline'),
